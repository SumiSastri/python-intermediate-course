# Class or entities - blueprint/template for methods and variables it contains
# eg. students, courses, emails
# Attributes/ Variables/Fields are either specific (instance variables) or generic (class variables)
# eg. the class variable number of students is generic, student name is specific or an instance variable
# Instance variables are not replicates but INSTANCES OF THE CLASS
# eg. individual students - s1/ s2 are not replicates but individual objects/ instances
# Actions, operations or methods are performed on variables - save, modify, print, delete
# Methods can also be generic (class methods) or specific (instance methods)
# A SPECIFIC FUNCTION WILL HAVE DEFINED ARGUMENTS A GENERIC CAN HAVE EMPTY VARIABLES
...
class Student: #PascalCase - eg. StudentDetail
    ...
    __noOfStudents = 0 # this is a class variable
